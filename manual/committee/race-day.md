...
![The start sheet for race 4: three of four boats ticked as racing, with persons on board, and a message that GBR 7 was added with no email sent](../images/race-day-start-sheet.png)
...
![A start sheet row refusing to take GBR 42 off because it has a result recorded, suggesting correcting it to DNC instead](../images/start-sheet-has-result.png)
...
![The Finishing view of race 4 on a tablet: the race clock, one boat still racing with a Finished button, and two boats finished in order, each with Undo and Edit](../images/race-day-finishing.png)
