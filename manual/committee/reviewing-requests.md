...
![A request to register a boat, showing its sail number, name, make, model, lengths and NHC base number](../images/request-register.png)
...
![A request to change a boat, with its NHC base number changing from 0.805 to 0.812 highlighted](../images/request-change.png)
...
![A request to enter a boat in a series](../images/request-entry.png)
...
![A change request that has not been approved because a reason is needed](../images/request-reason-needed.png)
